...
async function reportStatus() {
  try {
    ...
    await prisma.$executeRawUnsafe(
      `INSERT INTO bot_status (bot_id, online, version, uptime_seconds, telegram_online, whatsapp_sessions, command_count, last_sync_at, last_sync_error, session_numbers, last_seen_at)
       VALUES ('main', true, $1, $2, true, $3, $4, $5::timestamp, $6, $7, CURRENT_TIMESTAMP)
