  ...
  for (let attempt = 1; attempt <= FETCH_ATTEMPTS; attempt++) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        lastError = "Signature verification failed — the website returned the public registry, which means BOT_API_KEY is missing or different in the website's Vercel environment (Settings → Environment Variables)";
      } else {
